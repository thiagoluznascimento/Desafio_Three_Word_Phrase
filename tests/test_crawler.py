...
class TestBucadorTHREEWORDPHRASE(TestCase):
    ...
    def setUp(self):
        ...
        self.nomes_imagens = self.instancia_crawler._extrai_link_imagens(self.htmls)
    ...
    def test_parser_nomes_imagens(self):
        ...
        for link in links_imagens:
            self.assertIsInstance(links_imagens, list)
            self.assertEqual(len(links_imagens), len(self.nomes_imagens))
